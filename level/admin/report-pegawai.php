...
if(isset($_GET["sort"])){
if (substr(($_GET['sort']),0,2)==20){
$search = $_GET['sort'];}
elseif( $_GET['sort'] !== "nama" and $_GET['sort'] !== "tanggal" and substr(($_GET['sort']),0,4)!==20){
$search=$_GET['sort'];}
}
...
<table class="table table-bordered" width="100%">
    ...
    <?php
			...
			elseif ( $_GET['sort'] !== "nama" and $_GET['sort'] !== "tanggal" and substr(($_GET['sort']),0,2)!==20){$query ="select * from uraian_tugas where Nama='$search' Limit $start, $perpage";
