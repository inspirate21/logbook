...
<head>
<meta charset="utf-8">
<title>Transaksi Anda - HEIS Futsal</title>
...
if ($rows > 0) {
	...
	echo "Jam Main:"." ".$i.".00-".$total.".00"."<br>";
...
<a href="payment.php?playdt=<?php echo $date;?>&
					...
					<a href="home-default.php"><button class="btn">Batal</button></a>
